    ...
    <Modal visible={visible} transparent animationType="fade" onRequestClose={onClose}>
      <View style={styles.modalOverlay}>
        <View style={[styles.modalContent, { backgroundColor }]}>
          <Text style={[styles.modalTitle, { color: textColor }]}>{i18n.update_cash_title}</Text>
          <TextInput
            style={[styles.modalInput, { color: textColor, borderColor: tintColor }]}
          ...
          <View style={styles.modalButtons}>
            ...
            <TouchableOpacity onPress={onSave} style={[styles.modalButton, { backgroundColor: tintColor }]}>
...
const styles = StyleSheet.create({
  ...
  modalInput: { borderWidth: 1, borderRadius: 8, padding: 12, fontSize: 18, fontWeight: "600", marginBottom: 24 },
