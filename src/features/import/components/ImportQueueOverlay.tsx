...
/**
 * Returns a human-readable icon and color for each queue status.
 */
...
/**
 * Floating overlay panel that shows the import queue progress.
...
export function ImportQueueOverlay(): React.ReactElement | null {
  ...
  // Slide animation when items appear/disappear
  useEffect(() => {
            ...
            return (
              ...
              >
                ...
                <View style={styles.itemInfo}>
                  ...
                  <Text
                    style={[styles.itemStatus, { color: statusInfo.color }]}
                  >
